return function()
  ...
  dap.adapters = {
    ...
    codelldb = {
      ...
      port = "${port}",
      executable = {
        --command = "/Users/chengpeng/.local/share/nvim/mason/bin/codelldb",
        command = "/Users/chengpeng/.local/share/nvim/mason/packages/codelldb/extension/adapter/codelldb",
        args = { "--port", "${port}" },
      },
    },
  }
